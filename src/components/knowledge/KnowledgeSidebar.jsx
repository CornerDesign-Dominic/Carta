...
const visibleKnowledgeSlugs = ['rechnung', 'angebot', 'lieferschein', 'gutschrift', 'quittung', 'eigenbeleg', 'faelligkeit', 'verzugszinsen', 'mahnverfahren', 'zinsen', 'zinseszins', 'break-even-point', 'kostenvergleichsrechnung', 'steuern', 'einkommensteuer', 'umsatzsteuer'];
