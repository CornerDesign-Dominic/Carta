...
const ersteMahnung = {
  ...
  seo: {
    title: "1. Mahnung einfach erklaert | Carta",
    description: "Die erste Mahnung erinnert sachlich an eine faellige offene Forderung.",
  ...
  faqs: [
    {
      ...
      answer: "Sie ist sinnvoll, wenn eine Rechnung faellig ist und der Kunde trotz Zahlungsziel noch nicht bezahlt hat.",
    },
    {
      question: "Welche Frist setzt man in einer ersten Mahnung?",
      answer: "Hauefig wird eine kurze, klare Zahlungsfrist gesetzt. Die passende Frist haengt vom Einzelfall und der bisherigen Kommunikation ab.",
    },
    {
      question: "Wie sollte eine erste Mahnung klingen?",
      answer: "Sie sollte sachlich, bestimmt und nachvollziehbar sein. Ein ruhiger Ton hilft, die Geschaeftsbeziehung nicht unnoetig zu belasten.",
    },
  ],
  related: [
    "zahlungserinnerung",
