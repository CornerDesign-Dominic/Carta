...
const rechnung = {
  ...
  seo: {
    title: "Rechnung einfach erklaert | Carta",
    description: "Eine Rechnung dokumentiert eine Lieferung oder Leistung und fordert den Empfaenger zur Zahlung auf.",
    canonicalPath: "/wissen/rechnung",
  },
  hero: {
    headline: "Rechnung",
    intro: "Eine Rechnung ist ein geschaeftliches Dokument, mit dem eine erbrachte Leistung oder Lieferung abgerechnet wird. Sie enthaelt die wichtigsten Angaben zu Anbieter, Kunde, Leistung, Betrag, Umsatzsteuer und Zahlungsziel.",
  },
  sections: [
    {
  ...
  faqs: [
    {
      ...
      answer: "Eine Rechnung sollte alle wichtigen Angaben enthalten, damit sie eindeutig, nachvollziehbar und buchhalterisch nutzbar ist. Dazu gehoeren unter anderem Name und Anschrift von Anbieter und Kunde, Rechnungsdatum, Rechnungsnummer, Leistungsdatum, Beschreibung der Leistung, Betrag, Umsatzsteuer und Zahlungsinformationen.",
    },
    {
      question: "Wann muss ich eine Rechnung schreiben?",
      answer: "Eine Rechnung wird in der Regel erstellt, wenn eine Lieferung oder Leistung gegenueber einem Kunden abgerechnet werden soll. Besonders im geschaeftlichen Bereich ist sie wichtig fuer Zahlung, Buchhaltung und Nachweis.",
    },
    {
    ...
    },
    {
      ...
      answer: "Das Zahlungsziel gibt an, bis wann die Rechnung bezahlt werden soll. Haeufige Formulierungen sind zum Beispiel \"zahlbar innerhalb von 14 Tagen\" oder ein konkretes Faelligkeitsdatum.",
    },
    {
      question: "Was ist eine Kleinunternehmerrechnung?",
      answer: "Bei einer Kleinunternehmerrechnung wird keine Umsatzsteuer ausgewiesen. Stattdessen enthaelt die Rechnung einen Hinweis auf die Anwendung der Kleinunternehmerregelung.",
    },
    {
      question: "Was ist das Reverse-Charge-Verfahren?",
      answer: "Beim Reverse-Charge-Verfahren schuldet nicht der leistende Unternehmer die Umsatzsteuer, sondern der Leistungsempfaenger. Das betrifft vor allem bestimmte grenzueberschreitende oder besondere geschaeftliche Leistungen.",
    },
    {
      question: "Was passiert, wenn eine Rechnung nicht bezahlt wird?",
      answer: "Wird eine Rechnung nicht bezahlt, kann zunaechst eine Zahlungserinnerung oder Mahnung versendet werden. Danach koennen weitere Schritte wie Verzugszinsen, Inkasso oder ein gerichtliches Mahnverfahren folgen.",
    },
  ],
  related: [
    "angebot",
  ...
  intro: "Eine Rechnung ist ein geschaeftliches Dokument, mit dem eine erbrachte Leistung oder Lieferung abgerechnet wird. Sie enthaelt die wichtigsten Angaben zu Anbieter, Kunde, Leistung, Betrag, Umsatzsteuer und Zahlungsziel.",
  typicalUse: "Eine Rechnung wird meist erstellt, nachdem eine Leistung erbracht oder eine Ware geliefert wurde. Sie dient als Zahlungsaufforderung und als Beleg fuer die Buchhaltung.",
  toolLink: "/dokumente/rechnung",
  toolLabel: "Rechnung erstellen",
  ctaText: "Nutze unseren kostenlosen, werbefreien und unbegrenzten interaktiven Generator, um deine individuelle Rechnung schnell und einfach zu erstellen.",
};
