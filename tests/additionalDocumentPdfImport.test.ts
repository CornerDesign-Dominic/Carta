...
const selfReceiptLabelKeys = ['title', 'recipientTitle', 'selfReceiptId', 'receiptDate', 'expenseDate', 'internalReference', 'externalReference', 'costCenter', 'position', 'expensePositionDate', 'description', 'netAmount', 'tax', 'grossAmount', 'net', 'taxAmount', 'grandTotal', 'occasion', 'reason', 'settlementType', 'location', 'contactEmail', 'contactPhone', 'contactFax', 'contactWebsite'];
...
function selfReceiptState(): SelfReceiptEditorState { const business = data({ selfReceiptId: 'EB-1', receiptDate: '2026-07-24', expenseDate: '2026-07-23' }, { internalReference: 'I', externalReference: 'E', costCenter: 'K-1' }); return { labels: labels(selfReceiptLabelKeys), selfReceiptData: { sender: business.sender, recipient: business.recipient, details: { selfReceiptId: 'EB-1', receiptDate: '2026-07-24', expenseDate: '2026-07-23' }, references: { internalReference: 'I', externalReference: 'E', costCenter: 'K-1' }, footer: business.footer, expenseInfo: { occasion: 'Termin', reason: 'Kein Fremdbeleg', settlementType: 'Bar', location: 'Berlin' } }, positions: [{ id: '123e4567-e89b-42d3-a456-426614174002', expenseDate: '2026-07-23', description: 'Leistung', netAmount: '42,00', taxRate: '19' }], fieldConfig: { ...businessConfig(['selfReceiptId', 'receiptDate', 'expenseDate', 'internalReference', 'externalReference', 'costCenter']), expenseInfo: { hidden: ['reason'], order: ['occasion', 'reason', 'settlementType', 'location'] } } }; }
